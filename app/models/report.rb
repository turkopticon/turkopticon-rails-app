...
class String
  def censor
    self.gsub(/[^A-Za-z]ass[^A-Za-z]|asshole|jackass|retard/i,"[rearward-facing primate orifice]").gsub(/fck|fuck|cunt|shit|douche|bitch|nigger|dick/i,"[delightful bamboo-eating panda]")
  end
end
